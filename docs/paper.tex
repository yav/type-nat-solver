...
The \Verb"push" command instructs to solver to save its state, then
...
In our small example, the work for the first assertion shared in
...
the plug-in and the rest of GHC (i.e., the main constraint solver,
